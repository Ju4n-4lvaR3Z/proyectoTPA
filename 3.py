...
class seccion_clima(ttk.Frame):
    ...
    # metodos de cambio del dia
    def change_day(self):
        self.dia_cambio.set(f"{self.calendario_time.strftime("%d")}")
        self.day()
    def day(self):
        self.dia= ttk.Label(self, textvariable=self.dia_cambio,background="#22252A",foreground="#FFFFFF")
    # primera seccion
    ...
    def grid(self):
        ...
        self.lines2.place(x=138,y=0,relwidth=0.012,relheight=1)
        ...
        self.gradosSec1.place(x=272,y=95,relwidth=0.3,relx=0,relheight=0.2)
        self.gradosSec2.place(x=274,y=119,relwidth=0.3,relx=0,relheight=0.2)
